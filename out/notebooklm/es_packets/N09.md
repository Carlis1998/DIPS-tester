# N09 — Trump II och den transatlantiska relationen

## Upload order

1. Skriftligt prov for diplomatprogrammet 2025
...
TOPIC:
Donald Trump's second presidency and its implications for transatlantic relations, NATO, Ukraine, trade, and Swedish strategic choices.
...
CURRENT RELEVANCE:
This topic affects nearly every part of Europe's security and economic environment.

EXAM RISK:
Very plausible essay topic in 2026.
```